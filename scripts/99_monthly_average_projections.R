...
preds <- rast(paste0("output/projections/", this.scenario, "/projections_", this.scenario, ".nc"))
...
for(i in months){
  ...
  #export
  writeCDF(monthly_avg, filename = paste0("output/projections/", this.scenario, "/monthly_avg_", longname, "_", this.scenario, ".nc"))
  ...
  #export
  ggsave(paste0("output/projections/", this.scenario, "/monthly_avg_", longname, ".png"), 
